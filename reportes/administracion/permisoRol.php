...
$sql=$dbh->prepare("SELECT nombreMenu, nombreSubmenu, nombreOpcion, fecAsignacion, hraAsignacion
                    FROM menu AS m, submenu AS s, opcion AS o, rol_opcion AS ro, rol as r
                    WHERE m.IDmenu = s.IDmenu
                    AND s.IDsubmenu = o.IDsubmenu
                    AND o.IDopcion = ro.IDopcion
...
ROL: <?php echo strtoupper($idrol);?><br>
