<?php
   ...
   $estado=$_POST["estado"];
	$consulta = $dbh->prepare("SELECT c.nombre, c.descripcion, c.unidadTrabajo, s.cantidad_contratada
	...
	if($consulta->rowCount() > 0 ){
		...
		$titulosColumnas = array('CARGO', 'DESCRIPCION','UNIDAD', 'CANTIDAD CONTRATADA');
