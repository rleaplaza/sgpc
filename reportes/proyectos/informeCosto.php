...
<link href="../../css/estilos.css" rel="stylesheet" type="text/css">
 <h2><legend>INFORME DE COSTO POR ACTIVIDAD</legend></h2>
...
#Consulta para recuperar el detalle del precio unitario de la actividad
  ...
  <tr><td><label>Actividad</label></td><td><?php echo $row[1];?></td></tr>
     ...
     <tr><td><label>Costo por maquinaria</label></td><td><?php echo $row[4]." Bs";?></td></tr>
     ...
     <tr><td><label>Costo</label></td><td><?php echo $row[12]." Bs";?></td></tr>
</table>
<?php
