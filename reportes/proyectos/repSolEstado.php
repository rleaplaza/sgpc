...
function Footer()
{
	...
	$pdf->Cell(90);
	$pdf->Cell(19,20,'Informe de solicitudes de mano de obra por estados');
	...
	$pdf->Cell(0,9,'ESTADO: '.$estado,0,1);
...
$pdf->Output('archivos/reporteSolicitudManoObraEstado.pdf','D');
?>