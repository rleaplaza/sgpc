...
function Header()
{
	...
	$this->Text(20,14,'Actividades sin material',0,'C', 0);
	$this->Ln(30);
...
function Footer()
{
	...
	$this->Cell(100,10,'Actividades sin material',0,0,'L');
	...
	$pdf->Cell(90);
	$pdf->Cell(19,20,'Informe de actividades sin material asignado');
...
$pdf->Output('archivos/ActividadSinMaterial.pdf','D');
?>