...
function Header()
{
	...
	$this->Text(20,14,'Actividades sin personal',0,'C', 0);
	$this->Ln(30);
...
function Footer()
{
	...
	$this->Cell(100,10,'Actividades sin personal',0,0,'L');
	...
	$pdf->Cell(90);
	$pdf->Cell(19,30,'Informe de actividades sin personal asignado');
...
$pdf->Output('archivos/ActividadSinPersonal.pdf','D');
?>