		    ...
		    try{
			 ...
			 if($consulta->rowCount()>0){
			  ...
			  $idopcion=$_GET["idopcion"];
               ...
               <form method="get" name="usuario">
               <table>
               <tr><td><select id="proyecto" name="proyecto" class="combo">
               <?php
               ...
               <input type="hidden" value="<?php echo $idopcion;?>" name="idopcion">
                <tr><td><input type="submit" id="sub1" value="INFORME DE AVANCES" onclick="this.form.action='listActAvance.php'"></td>
