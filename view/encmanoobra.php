...
<script type="text/javascript" language="JavaScript">
        $(document).ready( function() {
            $("#tableEncargado").dataTable({//función que enlaza al id de la tabla
				"sScrollY":"200px",
				"bPaginate":true
				});
        });
      ...
      <thead>
       ...
       <style>
		...
		$sql=$dbh->prepare("SELECT USR_UID, username, nombreRol
                            ...
                            AND rol.IDrol = 'SC_PROVEEDOR_MANO_OBRA' 
							order by username");
		$sql->execute();
		if($sql->rowCount()>0){
			foreach($sql->fetchAll() as $row){
                ...
                <td><a href="<?php echo "nuevoEncargado.php?iduser=$iduser";?>">Completar registro</a></td></tr>
                <?php
				}
		}
				?>
