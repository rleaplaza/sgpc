...
?>
<img src="../images/material.jpg" width="60" height="60" /> 
<fieldset>
<legend>Formulario de actividades sin material asignado</legend>
...
<tr><td><label>Fase</label></td><td><select name="fase" class="fase" onChange="Subfase(this.value)" required>
  ...
  if($consulta->rowCount()>0){
	  ...
	  foreach($consulta->fetchAll() as $fila){
		...
		?>
        <option value="">_Ninguna fase para el proyecto
          <?php
		}
  ?>
</select>
...
<option value="">_carga de subfase</select>
  ...
  <tr><td><input type="submit" value="IMPRIMIR" onClick="this.form.action='../reportes/proyectos/Act_Material.php'"></td><td><input class="reset" type="reset" value="VACIAR FORMULARIO"></td></tr>
  </table>
          </form>
          </fieldset>
