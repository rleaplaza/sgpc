...
<script type="text/javascript" src="registros/lightface/Source/LightFace.Request.js"></script>   
  <script type="text/javascript">
	window.addEvent('domready',function(){
				...
				ajaxFace = new LightFace.Request({//instancia a la clase
					...
					request: { 
						...
						//captura de varibales del formulario para enviarlos al archivo php de la URL
							...
							Cant_usada:document.id('cant_usada').value || 'Cantidad no encontrada',
							HoraInicio:document.id('horaInicio').value || 'Cantidad no almacenada',
							HoraFin:document.id('horaFin').value || 'Cantidad no almacenada'
						},
						method: 'post'
					},
		...
		function limpiar(){
			document.getElementById("cant_usada").value="";
...
if(isset($_SESSION["username"])){//verifica la existencia de nombre de usuario
    ...
    <fieldset>
    <legend>FORMULARIO DE USO DE EQUIPAMIENTO</legend>
    ...
    <input type="hidden"  class="idmaquinaria" id="idmaquinaria" value="<?php echo $idmaquinaria;?>">
     <div><tr><td><label>Equipamiento</label></td><td><input type="text"  class="nombre" id="nombre" value="<?php echo $desc;?>" readonly></td></tr></div>
    ...
    <div><tr><td><label>Cantidad asignada</label></td><td><input type="text" id="cant_asignada" class="cant_asignada" value="<?php echo $cantidad_asignada;?>" readonly></td></tr></div>
    <div><tr><td><label>Cantidad utilizada</label></td><td><input type="text" id="cant_usada" class="cant_usada" maxlength="6"></td></tr></div>
     <div><tr><td><label>Hora de inicio</label></td><td><input type="text" id="horaInicio" class="horaInicio" maxlength="8"><img src="../images/ayuda.jpg" title="Escriba la hora en formato hh:mm:ss" height="20" width="20"></td></tr></div>
     <div><tr><td><label>Hora de fin</label></td><td><input type="text" id="horaFin" class="horaFin" maxlength="8"><img src="../images/ayuda.jpg" title="Escriba la hora en formato hh:mm:ss" height="20" width="20"></td></tr></div>
