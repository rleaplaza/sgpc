...
?>
<img src="../images/maquinaria1.jpg" width="60" height="60" /> 
<fieldset>
<legend>Formulario de actividades sin equipamiento asignado</legend>
...
<option value="">_carga de subfase</select>
  ...
  <tr><td><input type="submit" value="IMPRIMIR" onClick="this.form.action='../reportes/proyectos/Act_Equipamiento.php'"></td><td><input class="reset" type="reset" value="VACIAR FORMULARIO"></td></tr>
