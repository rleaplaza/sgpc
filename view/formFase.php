		    ...
		    try{
			 ...
			 if($consulta->rowCount()>0){
			  ...
			  $idopcion=$_GET["idopcion"];
               ...
               <tr><td><input type="submit" id="sub" value="NUEVA FASE" onclick="this.form.action='formularioFase.php'">
                <input type="submit" id="sub" value="LISTADO DE FASES" onclick="this.form.action='listFases.php'"></td>
               </tr>
               </table>
               </form>
               <?php
