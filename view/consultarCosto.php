...
<style>
      ...
      <h2><legend>DETALLE DE COSTO POR ACTIVIDAD</legend></h2>
        <img src="../images/precios.jpg" width="30" height="30" />
        <a href="<?php echo "../reportes/proyectos/informeCosto.php?idactividad=$idactividad&user=$user";?>"><img src="../images/pdf.jpg" width="30" height="30" title="Imprimir informe en PDF"></a><br>
...
#Consulta para recuperar el detalle del precio unitario de la actividad
	...
	?>
     ...
     <tr><td><label>Costo por material</label></td><td><?php echo $row[2]." Bs";?></td></tr>
     <tr><td><label>Costo por mano de obra</label></td><td><?php echo $row[3]." Bs";?></td></tr>
     <tr><td><label>Costo por equipamiento</label></td><td><?php echo $row[4]." Bs";?></td></tr>
     ...
     <tr><td><label>Precio</label></td><td><?php echo $row[11]." Bs";?></td></tr>
     <tr><td><label>Costo total</label></td><td><?php echo $row[12]." Bs";?></td></tr>
</table>
        <?php
