		    ...
		    try{
			 ...
			 if($consulta->rowCount()>0){
		      ...
		      echo("<label>".$row["nombreopcion"]."</label></p>");
               ...
               <h2><legend>Seleccione un proyecto para enviar al listado de la solicitud</legend></h2><br>
               <form method="post">
               <table>
			   ...
			   if($sql->rowCount()>0){
                  ...
                  <option value="<?php echo $row["IDproyecto"]?>"><?php echo $row["nombre"];?>
					   ...
					   ?>
                       <option value=""><?php echo "Ningún proyecto registrado"?>
                       <?php
					   }
			   ?>
               </select>
               </td>
               <td><input type="submit" id="sub" value="ENVIAR" onclick="this.form.action='listContratacion.php'"></td>
               </tr>
               </table>
               </form>
               <?php
