...
<div class="tabbertab">
        <h2><legend>REGISTRO DE DEPARTAMENTOS</legend></h2>
        <img src="../images/deptos.jpg" width="50" height="50" />
      ...
      <thead>
       ...
       <style>
        ...
        <?php
		$sql=$dbh->prepare("select *from departamento order by nombre");
		$sql->execute();
		if($sql->rowCount()>0){
			foreach($sql->fetchAll() as $row){
                ...
                <td><?php echo $row["fecCreacion"];?>
                <td><?php echo $row["hraCreacion"];?></td>
                 <td><a href="<?php echo "edit/editDepto.php?iddepto=$row[IDdepto]";?>">Editar Departamento</a></td></tr>
                <?php
				}
		}
				?>
