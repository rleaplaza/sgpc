...
?>
<img src="../images/requerimiento.jpg" width="50" height="50" /> 

<fieldset>
<legend>Formulario de consulta de requerimientos</legend>
<form method="post" class="usuario" id="formulario" name="form1">
<table align="left">
<div><tr><td><label>Seleccione un estado</label></td><td><select name="opt" id="opt" class="opt" required>
<option value="">_Seleccione una opción
<option value="material">Materiales
<option value="equipamiento">Equipamiento
</select></div>
  <input type="hidden" value="<?php echo $user;?>" name="user">
  <input type="hidden" value="<?php echo $_GET["idopcion"];?>" name="idopcion">
  <tr><td><input type="submit" value="CONSULTAR" onClick="this.form.action='requerimientos.php'"></td></tr>
 </div> 
