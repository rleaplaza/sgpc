<?php session_start();//función de inicio de sesiones?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="tabbertab">
        <h2><legend>REGISTRO DE CARGOS</legend></h2>
        <img src="../images/cargo.jpg" width="50" height="50" />
        <table id="tableCargo" width="814" align="left">
      <thead>
            	<tr>
           <th><label>Nombre de cargo</label></th>
           <th><label>Descripcion del cargo</label></th>
       ...
       <style>
        ...
        <?php
		$sql=$dbh->prepare("select *from cargo order by nombre");
		$sql->execute();
		if($sql->rowCount()>0){
			foreach($sql->fetchAll() as $row){
                ...
                <td align="center"><?php echo $row["fecCreacion"];?></td>
                <td align="center"><?php echo $row["hraCreacion"];?></td>
                <td align="center"><a href="<?php echo "edit/editCargo.php?idcargo=$row[IDcargo]";?>">Editar</a></td></tr>
                <?php
				}
		}
				?>
