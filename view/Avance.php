		    ...
		    try{
			 ...
			 if($consulta->rowCount()>0){
			  ...
			  $idopcion=$_GET["idopcion"];
			   ...
			   ?>
               <h2><legend>Control de avance de actividades</legend></h2>
               ...
               <input type="hidden" value="<?php echo $idopcion;?>" name="idopcion">
                <td><input type="submit" id="sub1" value="LISTADO DE ACTIVIDADES" onclick="this.form.action='envRepAvance.php'"></td>
               </tr>
               </table>
               </form>
               <?php
